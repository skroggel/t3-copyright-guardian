...
class MediaSourceRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
    ...
    public function findAllByPage(
        ...
        if ($tableFieldExpression = $this->buildTableFieldExpressionForPage($queryBuilder, $pid, $tableFields)) {
            ...
            // make sure the correspondending pages and contents are not hidden or deleted
     ...
     */
    protected function buildTableFieldExpressionForForeignUid(QueryBuilder $queryBuilder, int $foreignUid, string $tableFields): CompositeExpression
    {
        ...
        $tableFieldExpression = CompositeExpression::or();
     ...
     * @return \TYPO3\CMS\Core\Database\Query\Expression\CompositeExpression
     */
    protected function buildTableFieldExpressionForPage(QueryBuilder $queryBuilder, int $pid, string $tableFields): CompositeExpression
    {
     ...
     * @return array
     */
    protected function getRootlinePages($field): array
    {
        $rootlinePages = [];
     ...
     *
     * @param \TYPO3\CMS\Core\Database\Query\QueryBuilder $queryBuilder
     * @param \TYPO3\CMS\Core\Database\Query\Expression\CompositeExpression $tableFieldExpression
     * @param int $languageUid
     * @return void
     */
    protected function buildBasicQuery (QueryBuilder $queryBuilder, CompositeExpression $tableFieldExpression, int $languageUid = 0): void {
